...
class GalaxyDonghua : ExtractorApi() {
    ...
    private fun decodeGdTokens(page: String): GdTokens? {
        ...
        val pd = grab(Regex("""\bpd\s*[:=]\s*['"]([^'"]+)['"]""")) ?: grab(Regex("""(?:window\.)?pd=["']([^"']+)["']""")) ?: return null
        val ps = grab(Regex("""\bps\s*[:=]\s*['"]([^'"]+)['"]""")) ?: grab(Regex("""(?:window\.)?ps=["']([^"']+)["']""")) ?: return null
        val qsx = grab(Regex("""\bqsx\s*[:=]\s*['"]([^"']+)['"]""")) ?: grab(Regex("""(?:window\.)?qsx=["']([^"']+)["']""")) ?: return null
        val kaken = grab(Regex("""\bkaken\s*[:=]\s*['"]([^"']+)['"]""")) ?: grab(Regex("""(?:window\.)?kaken=["']([^"']+)["']""")) ?: return null
        val apx = grab(Regex("""\bapx\s*[:=]\s*['"]([^"']+)['"]""")) ?: grab(Regex("""(?:window\.)?apx=["']([^"']+)["']""")) ?: return null
