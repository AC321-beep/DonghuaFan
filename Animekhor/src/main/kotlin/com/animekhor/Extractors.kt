...
// ============================================================================
// EXPLICIT JS UNPACKERS (Fixes silent failures from built-in extractors)
// ============================================================================
...
class Emturbovid : ExtractorApi() {
    ...
    override suspend fun getUrl(
        ...
        // Restored EXACTLY to the version you confirmed works and plays
...
class AbyssPlayer : ExtractorApi() {
    ...
    override suspend fun getUrl(
        ...
        val m3u8 = Regex("""[fF]ile\s*:\s*["'](https?://[^"']+\.m3u8[^"']*)["']""").find(unpacked ?: "")?.groupValues?.get(1)
            ?: Regex("""src\s*:\s*["'](https?://[^"']+\.m3u8[^"']*)["']""").find(unpacked ?: "")?.groupValues?.get(1)
